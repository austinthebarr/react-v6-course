...
// re render one part of page not entire page
// NEVER put a hook in a for loop / if
...
const ANIMALS = ["bird", "dog", "whale", "dolphin"];
...
const SearchParams = () => {
  ...
  // you have to tell it when to run if you dont infinite loop
  // this will call it only once when page renders
